...
public class BookController {
    ...
    public String addToCart(HttpServletRequest request,HttpServletResponse response){
    	...
    	if (idString !=null) {
			...
			System.out.println("购物车有书："+shoppingCart.getShoppingCartItems().size());
	...
	public String listCarts(HttpServletRequest request,HttpServletResponse response){
		System.out.println("--------------------------------RequestMapping(listCarts)");
